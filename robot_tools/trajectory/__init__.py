...
__all__ = ['plan_traj_with_lfpb', 'Interp', 'eq1', 'eq2', 'eq3', 'eq4', 'eq5', 'eq6', 'eq7', 'fourier_circle_velocity', 'square_xz_velocity', 'figure_eight_velocity', 'spiral_velocity', 'zigzag_velocity']